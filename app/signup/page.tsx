...
export default function SignupPage() {
  ...
  const t = {
    ...
    de: {
      ...
      password: 'Passwort',
      signup: 'Registrieren',
      or: 'Oder registrieren Sie sich mit',
      google: 'Google',
      facebook: 'Facebook',
      apple: 'Apple',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After successful signup, you might want to update the user's profile with their name
      // This would require an additional API call to Supabase
      router.push('/')
    } catch (error) {
